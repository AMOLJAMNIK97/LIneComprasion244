...
namespace LineComprasionComputation
{
    public class CheckLength
    {
        ...
        public void LengthOfLine1()
        {
            ...
            CheckLength Cal = new CheckLength();
            double lengthOfLine1 = Cal.LengthOfLine(x1, x2, y1, y2);
            double lengthOfLine2 = Cal.LengthOfLine(m1, m2, n1, n2);
            ...
            Cal.checkEquality(lengthOfLine1, lengthOfLine2);
            Console.ReadLine();
        }
    }
}
